    ...
    defineCommand(
      {
        ...
        flags: {
          ...
          subnet: {
            type: String,
            description: 'CIDR to sweep (example: 192.168.68.0/24). Required when using --sweep.',
          },
          ...
          key: {
            type: String,
            description: 'Meross key (or set MEROSS_KEY). Falls back to dump cloud key if provided.',
          },
